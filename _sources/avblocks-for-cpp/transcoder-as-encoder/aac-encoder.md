---
title: AAC Encoder ADTS (Push)
html_meta:
    description: This article explains how you can use Transcoder to encode an AAC (Advanced Audio Coding) ADTS (Audio Data Transport Stream) audio stream from raw audio frames.
taxonomy:
    category: docs
---
