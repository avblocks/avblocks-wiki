---
title: MP3 Encoder (Run)
html_meta:
    description: This article explains how you can use Transcoder to encode a WAV file to MP3 (MPEG Audio Layer III) format.
taxonomy:
    category: docs
---
...
This article explains how you can use [Transcoder::run](https://doc.avblocks.com/core/latest/classprimo_1_1avblocks_1_1_transcoder.html#a31cbef423193a454b2634083cfb9b5cb) to encode a WAV file to MP3 (MPEG Audio Layer III) format.

The code snippets in this article are from the [enc_mp3_file](https://github.com/avblocks/avblocks-cpp/tree/main/samples/darwin/enc_mp3_file) macOS sample.
...
See the [build instructions](https://github.com/avblocks/avblocks-cpp/blob/main/docs/build-mac.md) for macOS and the [enc_mp3_file](https://github.com/avblocks/avblocks-cpp/tree/main/samples/darwin/enc_mp3_file) example for details.
