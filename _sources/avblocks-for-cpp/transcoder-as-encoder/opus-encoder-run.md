---
title: Opus Encoder (Run)
html_meta:
    description: This article explains how you can use Transcoder to encode a WAV file to Opus audio in an OGG container.
taxonomy:
    category: docs
---
...
This article explains how you can use [Transcoder::run](https://doc.avblocks.com/core/latest/classprimo_1_1avblocks_1_1_transcoder.html#a31cbef423193a454b2634083cfb9b5cb) to encode a WAV file to Opus audio stored in an OGG container.

The code snippets in this article are from the [enc_opus_file](https://github.com/avblocks/avblocks-cpp/tree/main/samples/darwin/enc_opus_file) macOS sample.
...
This code takes a WAV file and encodes it to Opus audio in an OGG container.
...
See the [build instructions](https://github.com/avblocks/avblocks-cpp/blob/main/docs/build-mac.md) for macOS and the [enc_opus_file](https://github.com/avblocks/avblocks-cpp/tree/main/samples/darwin/enc_opus_file) example for details.
...
The following example encodes input file `./assets/aud/equinox-48KHz.wav` into output file `equinox-48KHz.opus`:
