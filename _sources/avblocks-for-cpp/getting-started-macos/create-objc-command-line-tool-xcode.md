...
4. [Download](https://github.com/avblocks/avblocks-core/releases/) the 64 bit version of AVBlocks for C++ (macOS). The file you need will have a name similar to `avblocks-v3.2.0-demo.1-darwin.zip` except for the version number which may be different. 
