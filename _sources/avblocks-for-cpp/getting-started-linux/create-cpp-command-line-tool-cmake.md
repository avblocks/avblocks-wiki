...
1. [Download](https://github.com/avblocks/avblocks-core/releases/) the 64 bit version of AVBlocks for C++ (Linux). The file you need will have a name similar to `avblocks-v3.2.0-demo.1-linux.tar.gz` except for the version number which may be different. 
